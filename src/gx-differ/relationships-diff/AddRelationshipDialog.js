...
import {Button, Dialog, DialogActions, DialogContent, DialogTitle, Grid, MenuItem, Select, Stack, Typography} from "@mui/material";
...
export default function AddRelationshipDialog({open, setOpen}) {
  ...
  function saveChanges() {
    ...
    recordsData.gx.relationships.sort((a, b) => relationshipCompareFunction(a, b, recordsData.gx.persons));
  ...
  return (
    <Dialog open={open} onClose={saveChanges} PaperComponent={PaperComponent} aria-labelledby="draggable-dialog-title">
