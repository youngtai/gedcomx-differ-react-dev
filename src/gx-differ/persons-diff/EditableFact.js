...
function createEditablePersonFactAttribute(attributeData, type, fact, factIndex, parentObject, parentObjectIndex, comparingTo, updateData, factTypes) {
  return (
...
export default function EditableFact({fact, factIndex, parentObject, parentObjectIndex, comparingTo, updateData, factTypes}) {
  ...
  if (type) {
    ...
    factAttributeElements.push(
      createEditablePersonFactAttribute(attributeData, type, fact, factIndex, parentObject, parentObjectIndex, comparingTo, updateData, factTypes)
    );
